...
public:
    ...
    void setup_scene() override
    {
        ...
        ModelObject* teddyObject = new ModelObject("Teddy", "../models/cel_shading_scene/teddybear.fbx", *cel_shading, glm::vec3(5.0, 0.05f, 14.7f), 1.0f, glm::vec3(-90.0f, 0.0, 180.0f));
        teddyObject->setTexture("../textures/cel_shading_scene/teddybear_base.png");
        
        ModelObject* teddyObject2 = new ModelObject("Teddy 2", "../models/cel_shading_scene/teddybear_2.gltf", *cel_shading, glm::vec3(9.7f, 0.06f, 10.0f), 0.5f, glm::vec3(-90.0f, 0.0, -75.0));
        ...
        ModelObject* drawerBlueObject = new ModelObject("Drawer Blue", drawer_model, *cel_shading, glm::vec3(9.7f, -1.0f, 10.0f), 0.65f, glm::vec3(0.0, -90.0f, 0.0));
        drawerBlueObject->setTexture("../textures/cel_shading_scene/drawer_blue.png");

        ModelObject* drawerWoodObject = new ModelObject("Drawer Wood", drawer_model, *cel_shading, glm::vec3(5.0f, -1.0f, 14.7f), 0.65f, glm::vec3(0.0, 180.0f, 0.0));
